...
def entry(old: str, new: str, label: str) -> str:
    return (
        "    (\n"
        f"        {old!r},\n"
        f"        {new!r},\n"
...
'''
    ...
    replacements = (
        ...
        (
            r"AHP corresponde a \textit{Analytic Hierarchy Process}",
            r"AHP, TOPSIS e ANP correspondem, respectivamente, a \textit{Analytic Hierarchy Process}",
            "definição conjunta de AHP",
        ),
        (
            r"TOPSIS a \textit{Technique for Order Preference by Similarity to Ideal Solution}",
            r"\textit{Technique for Order Preference by Similarity to Ideal Solution}",
            "definição conjunta de TOPSIS",
        ),
        (
            r"ANP a \textit{Analytic Network Process}",
            r"\textit{Analytic Network Process}",
            "definição conjunta de ANP",
        ),
    )

    for old, new, label in replacements:
        block = entry(old, new, label)
