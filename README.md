...
- **[Baixar a versão Word para leitura e impressão](artigo.docx?raw=1)**
...
>
> O PDF compilado é a versão editorial de referência. O Word é uma cópia visual paginada do PDF validado, destinada à leitura, impressão e compartilhamento. A fonte editável oficial permanece em LaTeX.
...
- [Gerador da cópia visual do PDF em Word](scripts/python/13_preparar_word.py)
