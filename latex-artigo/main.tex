...
\author{Adinailson Guimarães de Oliveira \\ Programa de Pós-Graduação em Biossistemas \\ Universidade Federal do Sul da Bahia (UFSB) \\[2mm] Fabricio Berton Zanchi \\ Programa de Pós-Graduação em Biossistemas \\ Universidade Federal do Sul da Bahia (UFSB)}
\date{}
...
\input{sections/03_resultados_discussao}
\input{sections/04_consideracoes_finais}
