...
O núcleo final não foi submetido a leitura de texto completo nem a avaliação formal de elegibilidade em texto completo. A triagem, a auditoria qualitativa e a extração de dimensões, critérios, métodos e contextos utilizaram exclusivamente título, resumo, palavras-chave e campos estruturados. Essa base documental permite identificar padrões de conteúdo declarado pelos próprios estudos, mas não constitui síntese de evidências extraídas de texto completo, avaliação de qualidade metodológica, avaliação de risco de viés ou verificação de resultados relatados. Um registro sinalizado para verificação pontual em texto completo foi excluído sem essa leitura, o que reforça o caráter documental do núcleo final.
