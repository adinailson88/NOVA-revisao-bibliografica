...
Na gestão pública universitária, o desempenho sustenta indicadores relacionados à continuidade e às falhas. A informação oferece as condições necessárias à rastreabilidade, enquanto o custo permite distinguir correções emergenciais, manutenção planejada e renovação. Registros de pagamento e planejamento conjunto de manutenção, renovação e energia reforçam essa combinação \parencite{kim_estimativacustoseducacional_2018,nageli_ciclovida_2019}.
