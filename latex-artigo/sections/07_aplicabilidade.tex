...
A análise das lacunas mostrou que 76 registros (62,8\%) apresentaram limitação identificável no resumo, enquanto 45 (37,2\%) não a explicitaram nesse nível documental. O campo mais amplo \texttt{lacuna\_ou\_limite\_identificado\_leitura} registra qualquer limitação mencionada; já o rótulo \texttt{lacuna\_para\_ies\_publicas} constitui um subconjunto específico, aplicado apenas quando a limitação se relaciona diretamente a instituições públicas de ensino superior. Doze registros (9,9\%) foram classificados nesse subconjunto, que reúne problemas de transferência, cobertura ou validação relacionados a essas instituições. Seus identificadores permanecem preservados na tabela-fonte do núcleo vigente.
