...
A análise das lacunas mostrou que 76 registros (62,8\%) apresentaram limitação identificável no resumo, enquanto 45 (37,2\%) não a explicitaram nesse nível documental. Doze registros (9,9\%) foram classificados especificamente como \texttt{lacuna\_para\_ies\_publicas}, categoria que reúne problemas de transferência, cobertura ou validação relacionados a instituições públicas de ensino superior. Seus identificadores permanecem preservados na tabela-fonte do núcleo vigente.
