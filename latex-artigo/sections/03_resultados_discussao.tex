...
A especificação proposta liga, assim, os critérios sustentados pela revisão a indicadores candidatos e a um fluxo de validação, convertendo dimensões e critérios recorrentes em etapas verificáveis e respondendo à RQ0. A baixa presença lexical de ODS e ESG, diante da recorrência de energia, emissões, segurança, conforto e governança, indica aproximação substantiva ainda pouco expressa por esses rótulos \parencite{ramantswana_esgfm_2026}. As coocorrências descrevem associações documentais, e a avaliação institucional determinará importância, pesos, método e robustez segundo a força e a disponibilidade dos dados, completando assim a cadeia entre a evidência da revisão e a decisão pública rastreável.
