...
Em resposta à RQ0, a matriz converte dimensões e critérios recorrentes em indicadores candidatos e etapas verificáveis. O produto entrega uma especificação para validação futura; a participação institucional e os dados reais completarão indicadores, normalização, pesos, agregação, limiares e vetos.