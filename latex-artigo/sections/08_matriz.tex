...
\footnotesize
\begin{tabularx}{\textwidth}{>{\RaggedRight\arraybackslash}p{2.3cm} Y >{\RaggedRight\arraybackslash}p{2.5cm} >{\RaggedRight\arraybackslash}p{1.55cm} >{\RaggedRight\arraybackslash}p{1.35cm}}
\toprule
