...
O Gráfico~\ref{fig:heatmap} apresenta a coocorrência entre os dez critérios de priorização e os dez instrumentos de apoio à decisão mais frequentes. Desempenho operacional e \textit{framework} aparecem conjuntamente em 88 registros. Informação e dados apresentam 71 coocorrências com \textit{framework} e 26 com BIM. Custo e \textit{framework} aparecem em 55 registros, enquanto vida útil e custo do ciclo de vida aparecem conjuntamente em 13.
