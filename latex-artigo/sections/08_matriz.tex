...
O Gráfico~\ref{fig:matrizanalitica} reorganiza essas relações em cinco dimensões. A dimensão técnica-operacional apresenta 100 coocorrências com \texttt{framework}, 28 com \texttt{decision\_support} e 28 com BIM. Em relação ao \texttt{framework}, a dimensão institucional apresenta 88 coocorrências, a ambiental 81, a econômica 56 e a social 54. Identificada em 65 registros, a dimensão de ciclo de vida atua transversalmente entre desempenho, custos e impactos no tempo.
...
A Figura~\ref{fig:fluxoprotocolo} resume o fluxo. A unidade de comparação precede a coleta, e os critérios e indicadores são validados antes da elicitação dos pesos. A divulgação da prioridade ocorre após a análise de sensibilidade e o registro das escolhas.
