...
\scriptsize
\begin{tabularx}{\textwidth}{>{\RaggedRight\arraybackslash}p{1.3cm} >{\RaggedRight\arraybackslash}p{3.1cm} >{\RaggedRight\arraybackslash}p{2.3cm} >{\RaggedRight\arraybackslash}p{3.6cm} Y}
\toprule
...
\scriptsize
\begin{tabularx}{\textwidth}{>{\RaggedRight\arraybackslash}p{1.3cm} >{\raggedleft\arraybackslash}p{1.1cm} >{\RaggedRight\arraybackslash}p{2.5cm} >{\RaggedRight\arraybackslash}p{2.6cm} >{\RaggedRight\arraybackslash}p{2.0cm} >{\raggedleft\arraybackslash}p{1.2cm} >{\raggedleft\arraybackslash}p{1.3cm} Y}
\toprule
