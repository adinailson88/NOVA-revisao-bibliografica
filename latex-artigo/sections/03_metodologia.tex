...
\scriptsize
\begin{tabularx}{\textwidth}{>{\RaggedRight\arraybackslash}p{1.5cm} >{\RaggedRight\arraybackslash}p{3.0cm} >{\RaggedRight\arraybackslash}p{2.2cm} >{\RaggedRight\arraybackslash}p{3.9cm} Y}
\toprule
...
\tiny
\begin{tabularx}{\textwidth}{>{\RaggedRight\arraybackslash}p{1.3cm} >{\raggedleft\arraybackslash}p{1.1cm} >{\RaggedRight\arraybackslash}p{2.6cm} >{\RaggedRight\arraybackslash}p{2.7cm} >{\RaggedRight\arraybackslash}p{2.1cm} >{\raggedleft\arraybackslash}p{1.2cm} >{\raggedleft\arraybackslash}p{1.3cm} Y}
\toprule
