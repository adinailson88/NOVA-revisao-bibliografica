...
\scriptsize
\begin{tabularx}{\textwidth}{>{\RaggedRight\arraybackslash}p{1.5cm} >{\RaggedRight\arraybackslash}p{3.1cm} >{\RaggedRight\arraybackslash}p{2.3cm} >{\RaggedRight\arraybackslash}p{3.6cm} Y}
\toprule
